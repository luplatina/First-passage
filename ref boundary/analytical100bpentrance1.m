function taux=analytical100bpentrance1(F_e0,Barx0,Diff,Uh0,Ldomain)
...
%flag0=(fix(Barx0/0.34)+1)/0.01;
flag0=find(xx>25*0.34e-9,1);
taux=tauL(flag0)*1000;
%plot(xx(340),tauL(340)*1000,'or')
%legend('mean backwards \tau','mean forwards \tau');
%ylabel('passage time (ms)')
%xlabel('location (m)')
%hold off

%analytical100bpentrance1(3*1.2,0.6,1400,18,6);
end
